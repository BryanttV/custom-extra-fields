#!/usr/bin/env python
"""
Package metadata for custom_extra_fields.
"""
...
VERSION = get_version("custom_extra_fields", "__init__.py")
...
setup(
    name="custom-extra-fields",
    version=VERSION,
    description="""An example app for extending user profile fields in Open edX""",
    long_description=README + "\n\n" + CHANGELOG,
    author="edunext",
    author_email="technical@edunext.co",
    url="https://github.com/edunext/custom-extra-fields",
    packages=find_packages(
        include=["custom_extra_fields", "custom_extra_fields.*"],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "custom_extra_fields = custom_extra_fields.apps:CustomExtraFieldsConfig",
        ],
    },
)
