...
"""
custom-extra-fields documentation build configuration file.
...
html_context = {
    ...
    "github_repo": "custom-extra-fields",  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edunext/custom-extra-fields",
...
#
# html_title = 'custom-extra-fields v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call(
        [
            ...
            "-o",
            docs_path,
            os.path.join(root_path, "custom_extra_fields"),
            os.path.join(root_path, "custom_extra_fields/migrations"),
        ]
    )
